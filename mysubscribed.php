...
<script>
    $(document).ready(function() {
        ...
        for (var i = 0; i < thealready.length; i++) {
            jQuery
            var settings = {
                "async": true,
                "crossDomain": true,
                "url": "https://api.themoviedb.org/3/movie/" + thealready[i] + "?api_key=3a413ffcc846a834f124769129b313b5&language=en-US",
                "method": "GET",
                "headers": {
            ...
            $.ajax(settings).done(function(response) {
                ...
                $('.movies').append('<div class="float-child"><a href="/movies.php?theid=' + response['id'] + '" class="movielink"><div class="green"><img src="https://image.tmdb.org/t/p/w500' + response['poster_path'] + '" style="width:100%"><div class="w3-container"><h4>' + response['title'] + '</h4></div></div></a></div>');
